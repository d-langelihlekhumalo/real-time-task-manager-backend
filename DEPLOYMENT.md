...
```
ConnectionStrings__DefaultConnection=Server=your-sql-server;Database=RealTimeTaskManager;User Id=your-username;Password=your-password;TrustServerCertificate=true;MultipleActiveResultSets=true;
```
...
2. **External SQL Server**
   - Ensure SQL Server is accessible from Coolify
   - Add firewall rules if needed
   - Use connection string in environment variable

3. **Coolify Database Service**
   - Deploy SQL Server container in Coolify
   - Connect via internal network
   - Use internal connection string

### **Connection String Format:**
```
Server=your-server.database.windows.net,1433;Database=RealTimeTaskManager;User Id=your-admin;Password=your-password;Encrypt=true;TrustServerCertificate=false;MultipleActiveResultSets=true;
```
...
```bash
# Database (REQUIRED)
ConnectionStrings__DefaultConnection=Server=your-sql-server;Database=RealTimeTaskManager;User Id=admin;Password=YourPassword123!;TrustServerCertificate=true;MultipleActiveResultSets=true;
